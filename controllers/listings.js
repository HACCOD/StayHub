...
module.exports.renderEditListingForm = async (req, res) => {
  ...
  let modifiedLink = originalImageLink.replace("/upload", "/upload/w_250,h_300")
  res.render("listings/edit", { listing, modifiedLink });
};
...
module.exports.filterCategory = async (req, res) => {
  const categoryName = req.query.category; // <-- this gets "Rooms"
